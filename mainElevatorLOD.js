...
function generateWorld() {
    ...
    const opaqueGlassMaterial = new THREE.MeshStandardMaterial({
        color: 0x101520, // Very dark blue/grey, like a tinted, non-transparent window
        metalness: 0.3,
        roughness: 0.2,
    ...
    currentElevatorConfig = {
        ...
        minFloorIndex: -SETTINGS.numBasementFloors,
    ...
    const secondElevatorConfig = {
        ...
        minFloorIndex: currentElevatorConfig.minFloorIndex,
        maxFloorIndex: currentElevatorConfig.maxFloorIndex,
        startFloorIndex: 0, // Start at ground floor
        platformMaterial: new THREE.MeshStandardMaterial({ color: 0x11aa11, metalness: 0.8, roughness: 0.5  }), // Different color
    ...
    const thirdElevatorConfig = {
        ...
        maxFloorIndex: currentElevatorConfig.maxFloorIndex,
        startFloorIndex: 0, // Start at ground floor
        platformMaterial: new THREE.MeshStandardMaterial({ color: 0x1111aa, metalness: 0.8, roughness: 0.5  }), // Blue color
        shaftMaterial: concreteMaterial,
        scene: scene,
        worldObjectsRef: worldObjects
    };
 ...
 */
        ...
        const shaftWallLeftGeo = new THREE.BoxGeometry(wallDepth, SETTINGS.floorHeight, overallShaftActualDepth+4);
        ...
        const shaftWallRightGeo = new THREE.BoxGeometry(wallDepth, SETTINGS.floorHeight, overallShaftActualDepth + 4);
