...
import { camera, playerHeight as initialPlayerHeight } from './sceneSetup.js';
 ...
 * @param {THREE.Scene} scene - The THREE.Scene object to add controls to.
 */
export function initializePlayerControls(instructionsElement, gameCanvas, scene) {
    if (!scene || typeof scene.add !== 'function') {
        console.error("initializePlayerControls: The 'scene' parameter is undefined or not a valid THREE.Scene object. Ensure a THREE.Scene instance is passed from the calling code (e.g., main.js).");
        throw new TypeError("Invalid 'scene' object provided to initializePlayerControls. It must be a THREE.Scene instance.");
    }
